...
class KingjuegoV4 extends StatefulWidget {
  
  const KingjuegoV4({ Key? key }) : super(key: key);
  @override
  State<KingjuegoV4> createState() => _CounterScreenState();
}

class _CounterScreenState extends State<KingjuegoV4> {
  ...
  void OnClicked(){
    ...
    setState(() {
      ...
      if (counter >= 0 ){
            ...
            nameValue=data[listaId[counter]]["Name"];
  ...
  void initState() {
    for (int i in newList) {
      ...
      _swipeItems.add(SwipeItem(
        content: Content(image: data[listaId[i]]["Imagen"].toString()),
        likeAction: () {
            print("Hola");
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text("Liked ${data[listaId[i]]["Imagen"].toString()}"),
    ...
    return Scaffold(
      ...
      children: [
        ...
        Center(
            ...
            //Al crear el expanded le dices con el flatbutton que pertenece al objeto en cuestion 
                ...
                child: SwipeCards(
                  ...
                  return Stack(
                    children: [
                      Container(child:
                Image.asset("assets/${_swipeItems[index].content.image}",
              ...
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text(listapersonaje.idioma==0?
                          "Todas las cartas han sido sacadas":"All the cards have been drawn",),
                duration: Duration(milliseconds: 500),
              ));
            },
          ...
          Text( listapersonaje.idioma==0?
                          'Cartas $counterMas/52':'Cards $counterMas/52', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color:Colors.black54) ),
          ...
          Text(listapersonaje.idioma==0?
                          "$nombreValor":"$nameValue", style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color:Colors.black),),
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Text(listapersonaje.idioma==0?
                          "$descripcionValor":"$descriptionvalue",style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color:Colors.black),)),
          ),
          SizedBox(height: size.height*0.05,),
